...
const Addpendingcrop = () => {
    ...
    await data1.map((crop) => {
      if (crop._id == params.id) {
        ...
        setorganicFertilizer(
          convertBackToOrganicFertilizer(crop.organicFertilizer)
        );
        setChemicalFerilizer(
          convertBackToChemicalcFertilizer(crop.chemicalFertilizer)
        );
  ...
  const [organicFertilizer, setorganicFertilizer] = useState([
    { name: "", description: "" },
  ]);
  ...
  const getFormattedOrganicFertilizer = () => {
    return organicFertilizer.map((organic) => ({
      [organic.name]: organic.description,
    }));
  };
  ...
  const [chemicalFerilizer, setChemicalFerilizer] = useState([
    { name: "", description: "" },
  ]);
  ...
  const getFormattedChemicalFertilizer = () => {
    return chemicalFerilizer.map((chemical) => ({
      [chemical.name]: chemical.description,
    }));
  };

  const convertBackToChemicalcFertilizer = (
    formattedChemicalFertilizer = []
  ) => {
      ...
      {cropdata ? (
        <>
          <div className="addcontanier">
            ...
            <div className="multiinput">
              ...
              <div className="textinputwithHeading">
                ...
                <input
                  ...
                  value={cropirr}
                  onChange={(e) => setCropirr(e.target.value)}
                />
              </div>
            </div>
            <div className="multiinput">
              <div className="textinputwithHeading">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (value === "" || numValue === 0) {
                      setErrorMessage(
                        "Value should be greater than 0 and less than 100"
                      );
                      setCroptemp("");
                    } else if (numValue > 0) {
                      setCroptemp(value);
              ...
              <div className="textinputwithHeading">
                ...
                <input
                  ...
                  style={{ width: "300px", marginLeft: "100px" }}
                  value={croploc}
                  onChange={(e) => setCroploc(e.target.value)}
                />
              </div>
            </div>
            {errorMessage && (
              <h6 className="errorMessageTemp">{errorMessage}</h6>
            )}
            <div className="textinput">
              <div className="textinputwithHeading">
                ...
                <textarea
                  type="text"
                  style={{ width: "700px", fontSize: "16px", padding: "20px" }}
                  rows="4"
                  value={cropdec}
                  onChange={(e) => setCropdec(e.target.value)}
                />
              </div>
            </div>
            <div className="multiinput">
              <div className="textinputwithHeading">
                ...
                <input
                  ...
                  style={{ width: "300px" }}
                  value={cropsub1}
                  onChange={(e) => setCropsub1(e.target.value)}
                />
              </div>
              <div className="textinputwithHeading">
                <span className="textinputRight">
                  SubCrops Recommendation 2
                </span>
                <input
                  type="text"
                  style={{ width: "300px", marginLeft: "100px" }}
                  value={cropsub2}
                  onChange={(e) => setCropsub2(e.target.value)}
                />
              </div>
            </div>
            <div className="multiinput">
              <div className="textinputwithHeading">
                ...
                <input
                  ...
                  style={{ width: "300px" }}
                  value={cropsub3}
                  onChange={(e) => setCropsub3(e.target.value)}
                />
              </div>
              <div className="textinputwithHeading">
                <span className="textinputRight">
                  SubCrops Recommendation 4
                </span>
                <input
                  type="text"
                  style={{ width: "300px", marginLeft: "100px" }}
                  value={cropsub4}
                  onChange={(e) => setCropsub4(e.target.value)}
                />
              </div>
            </div>
            ...
            <div className="multiinput">
              <div className="textinputwithHeading">
                ...
                <input
                  ...
                  style={{ width: "300px" }}
                  value={cropvar1}
                  onChange={(e) => setCropvar1(e.target.value)}
                />
              </div>
              <div className="textinputwithHeading">
                ...
                <input
                  ...
                  style={{ width: "300px", marginLeft: "100px" }}
                  value={cropvar2}
                  onChange={(e) => setCropvar2(e.target.value)}
                />
              </div>
            </div>
            <div className="multiinput">
              <div className="textinputwithHeading">
                ...
                <input
                  ...
                  style={{ width: "300px" }}
                  value={cropvar3}
                  onChange={(e) => setCropvar3(e.target.value)}
                />
              </div>
              <div className="textinputwithHeading">
                ...
                <input
                  ...
                  style={{ width: "300px", marginLeft: "100px" }}
                  value={cropvar4}
                  onChange={(e) => setCropvar4(e.target.value)}
                />
              </div>
            </div>
            <div className="textinput">
            ...
            {errorMessage1 && (
              <h6 className="errorMessagePrice">{errorMessage1}</h6>
            )}
            <span className="textinputCheckbox">Crop growing states</span>
            <div className="checkbox">
              <input
                type="checkbox"
                checked={isCheckedKerala}
                onChange={handleCheckboxChangeKerala}
              />
              <span className="checkboxText">Kerala</span>
              <input
                type="checkbox"
                checked={isCheckedKarnataka}
                onChange={handleCheckboxChangeKarnataka}
              />
              <span className="checkboxText">Karnataka</span>
              <input
                type="checkbox"
                checked={isCheckedTamilnadu}
                onChange={handleCheckboxChangeTamilnadu}
              />
              <span className="checkboxText">Tamilnadu</span>
              <input
                type="checkbox"
                checked={isCheckedAndrapradesh}
                onChange={handleCheckboxChangeAndrapradesh}
              />
              ...
              <div className="textinputwithHeading">
                ...
                {organicFertilizer.map((organic, index) => (
                  <div key={index} className="textinput">
                    <div className="textinputwithHeading">
                      <>
                        <span className="textinputLeftTimeframe1">
                          Step {index + 1}
                        </span>
                        <div className="multiinput">
                          <div className="textinputwithHeading">
                            <div style={{ marginBottom: "10px" }}>
                              <span className="textinputLeftTimeframe">
                                Timeframe
                              </span>
                            ...
                            <input
                              type="text"
                              placeholder="eg: 0-10days"
                              style={{ width: "140px" }}
                              value={organic.name}
                              onChange={(e) =>
                                handleorganicFertilizerChange(
                                  index,
                                  "name",
                                  e.target.value
                                )
                          ...
                          <div className="textinputwithHeading">
                            <span className="textinputRightForFertilizer">
                              Description
                            </span>
                            <input
                              type="text"
                              style={{ width: "510px", marginLeft: "50px" }}
                      ...
                      <div className="youtubeButtonadd">
                        {index === organicFertilizer.length - 1 && (
                          <div>
                            <button
                              className="addButton"
                              onClick={handleAddorganicFertilizer}
                            >
                              Add
                            </button>
                          </div>
                          ...
                          index !== organicFertilizer.length - 1 && (
                            <div>
                              <button
                                ...
                                onClick={() =>
                                  handleRemoveorganicFertilizer(index)
                                }
                              >
                                Remove
                              </button>
                      ...
                      <div className="youtubeButtonadd">
                        {index === chemicalFerilizer.length - 1 && (
                          <div>
                            <button
                              className="addButton"
                              onClick={handleAddChemicalFerilizer}
                            >
                              Add
                            </button>
                          </div>
                          ...
                          index !== chemicalFerilizer.length - 1 && (
                            <div>
                              <button
                                className="removeButton1"
                                onClick={() =>
                                  handleRemoveChemicalFerilizer(index)
                                }
                              >
                                Remove
                              </button>
                    ...
                    <div className="textinputwithHeading">
                      <>
                        ...
                        <input
                          ...
                          value={link}
                          onChange={(e) =>
                            handleHarvestingChange(index, e.target.value)
                          }
                        />
                      </>
                      <div className="youtubeButtonadd">
                        ...
                        {index > 0 && index !== harvesting.length - 1 && (
                          <div>
                            <button
                              className="removeButton1"
                              onClick={() => handleRemoveHarvesting(index)}
                            >
                              Remove
                            </button>
                          </div>
                    ...
                    <div className="textinputwithHeading">
                      <>
                        ...
                        <input
                          ...
                          value={link}
                          onChange={(e) =>
                            handleSeedingChange(index, e.target.value)
                          }
                        />
                      </>
                      <div className="youtubeButtonadd">
                        ...
                        {index > 0 && index !== seeding.length - 1 && (
                          <div>
                            <button
                              className="removeButton1"
                              onClick={() => handleRemoveSeeding(index)}
                            >
                              Remove
                            </button>
                          </div>
                    ...
                    <div className="textinputwithHeading">
                      <>
                        ...
                        <input
                          ...
                          value={link}
                          onChange={(e) =>
                            handleSoilPreparationChange(index, e.target.value)
                          }
                        />
                      </>
                      <div className="youtubeButtonadd">
                        {index === soilPreparation.length - 1 && (
                          <div>
                            <button
                              className="addButton"
                              onClick={handleAddSoilPreparation}
                            >
                              Add
                            </button>
                          </div>
                        ...
                        {index > 0 && index !== soilPreparation.length - 1 && (
                          <div>
                            <button
                              className="removeButton1"
                              onClick={() => handleRemoveSoilPreparation(index)}
                            >
                              Remove
                            </button>
                          </div>
                    ...
                    <div className="textinputwithHeading">
                      <>
                        ...
                        <input
                          ...
                          value={link}
                          onChange={(e) =>
                            handleWaterManagementChange(index, e.target.value)
                          }
                        />
                      </>
                      <div className="youtubeButtonadd">
                        {index === waterManagement.length - 1 && (
                          <div>
                            <button
                              className="addButton"
                              onClick={handleAddWaterManagement}
                            >
                              Add
                            </button>
                          </div>
                        ...
                        {index > 0 && index !== waterManagement.length - 1 && (
                          <div>
                            <button
                              className="removeButton1"
                              onClick={() => handleRemoveWaterManagement(index)}
                            >
                              Remove
                            </button>
                          </div>
