      ...
      <div className='marketcard'>
        ...
        <div className='cardlist'>
          {fertilizerMarket.map((fertilizerdata)=>(
           <Fertilizercard id={fertilizerdata._id} data={fertilizerdata} categori={categori} type={categoritype[0]}/>
          ))}
        </div>
      </div>
      <div className='marketcard'>
        ...
        <div className='cardlist'>
        {fertilizerMarket.map((fertilizerdata)=>(
           <Fertilizercard id={fertilizerdata._id} data={fertilizerdata} categori={categori} type={categoritype[1]}/>
          ))}
        </div>
      </div>
